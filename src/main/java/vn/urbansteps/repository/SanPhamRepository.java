...
public interface SanPhamRepository extends JpaRepository<SanPham, Integer> {
    ...
    List<SanPham> findByTrangThaiOrderByGiaBanAsc(@Param("trangThai") Boolean trangThai);
       ...
       @Query("SELECT DISTINCT sp FROM SanPham sp " +
          ...
          "LEFT JOIN FETCH sp.kieuDang " +
          "LEFT JOIN FETCH sp.chatLieu " +
          "WHERE sp.trangThai = :trangThai ORDER BY sp.giaBan DESC")
   ...
   // Tìm kiếm sản phẩm theo tên
      @Query("SELECT DISTINCT sp FROM SanPham sp " +
            ...
            "LEFT JOIN FETCH sp.kieuDang " +
            "LEFT JOIN FETCH sp.chatLieu " +
            "WHERE sp.tenSanPham LIKE %:keyword% AND sp.trangThai = :trangThai")
   ...
   // Tìm sản phẩm hot
      @Query("SELECT DISTINCT sp FROM SanPham sp " +
            ...
            "LEFT JOIN FETCH sp.kieuDang " +
            "LEFT JOIN FETCH sp.chatLieu " +
            "WHERE sp.laHot = true AND sp.trangThai = :trangThai ORDER BY sp.luotXem DESC, sp.diemDanhGia DESC")
   ...
   // Tìm sản phẩm sale
      @Query("SELECT DISTINCT sp FROM SanPham sp " +
            ...
            "LEFT JOIN FETCH sp.kieuDang " +
            "LEFT JOIN FETCH sp.chatLieu " +
            "WHERE sp.laSale = true AND sp.phanTramGiam > 0 AND sp.trangThai = :trangThai ORDER BY sp.phanTramGiam DESC")
   ...
   // Sản phẩm bán chạy
      @Query("SELECT DISTINCT sp FROM SanPham sp " +
            ...
            "LEFT JOIN FETCH sp.kieuDang " +
            "LEFT JOIN FETCH sp.chatLieu " +
            "WHERE sp.trangThai = :trangThai ORDER BY sp.luotBan DESC, sp.luotXem DESC")
   ...
   // Sản phẩm xem nhiều
      @Query("SELECT DISTINCT sp FROM SanPham sp " +
            ...
            "LEFT JOIN FETCH sp.kieuDang " +
            "LEFT JOIN FETCH sp.chatLieu " +
            "WHERE sp.trangThai = :trangThai ORDER BY sp.luotXem DESC")
   ...
   // Sản phẩm đánh giá cao
      @Query("SELECT DISTINCT sp FROM SanPham sp " +
            ...
            "LEFT JOIN FETCH sp.kieuDang " +
            "LEFT JOIN FETCH sp.chatLieu " +
            "WHERE sp.diemDanhGia >= :minRating AND sp.soLuongDanhGia >= :minReviews AND sp.trangThai = :trangThai ORDER BY sp.diemDanhGia DESC, sp.soLuongDanhGia DESC")
   ...
   // Tìm theo khoảng giá sau giảm
      @Query("SELECT DISTINCT sp FROM SanPham sp " +
            ...
            "LEFT JOIN FETCH sp.kieuDang " +
            "LEFT JOIN FETCH sp.chatLieu " +
            "WHERE sp.trangThai = :trangThai AND " +
   ...
   // Tìm sản phẩm mới (theo ngày tạo)
      @Query("SELECT DISTINCT sp FROM SanPham sp " +
            ...
            "LEFT JOIN FETCH sp.kieuDang " +
            "LEFT JOIN FETCH sp.chatLieu " +
            "WHERE sp.trangThai = :trangThai ORDER BY sp.createAt DESC")
